    ...
    void accelerate_motor_right(Direction direction, int duty_c);       // function to accelerate the right motor, direction is the rotation (clockwise cw or counterclockwise ccw) and duty_c is the duty cycle percentage
    ...
    void rotate(Direction direction, int duty_c);                       // function to rotate the car around your own axis, with one motor in cw and the other ccw
